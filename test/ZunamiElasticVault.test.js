...
contract('ZunamiElasticVault', function (accounts) {
    ...
    describe('fee', async function () {
        beforeEach(async function () {
            ...
            await this.vault.mockMint(holder, parseShare(150), parseShare(100));
        });
        ...
        it('should be withdraw', async function () {
            ...
            expect(await this.vault.previewWithdraw(parseToken(100))).to.be.bignumber.equal(
                "66000000000000000000" // 66666666666666666667 - (1% * 66666666666666666667)
            );
            ...
            expect(await this.token.balanceOf(other)).to.be.bignumber.equal("15000000000000000");
        });
    ...
    describe('limits', async function () {
        ...
        it('withdraw', async function () {
            ...
            expect(await this.vault.maxWithdraw(holder)).to.be.bignumber.equal(parseShare(15225));
